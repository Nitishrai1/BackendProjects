    ...
    <div className="flex bg-[#f2f6fe] min-h-screen border-box">
      ...
      <div className="flex-1">
        ...
        <div className="p-5 max-h-screen">
          <div className="flex flex-col lg:flex-row gap-4 rounded-3xl min-h-full">
            {/* Left flex column */}
            <div className="flex-1 p-5 rounded-3xl bg-white">
              ...
              <div className="todo-list flex flex-wrap">
                {filterdTodos.map((todo) =>
                  ...
                  filterdTodos.length > 0 ? <Todo todo={todo} /> : <div>
                    <h2>No data Found</h2>
                  </div>
                )}
              </div>
